...
KANBAN_GUIDANCE = (
    ...
    "## Lifecycle\n"
    "\n"
    "1. **Orient.** Call `kanban_show(mode=\"compact\")` first (task_id "
    "defaults to your task). It preserves core task fields, dependency IDs, "
    "counts, the bounded worker context, latest comment, handoffs/blockers, "
    "and artifact paths. Follow its visible `full_hint` only when raw history "
    "is required.\n"
