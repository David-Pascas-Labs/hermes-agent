...
DEFAULT_CONFIG = {
    ...
    "agent": {
        "max_turns": 500,
        # Ordinary messaging turns are intentionally bounded more tightly than
        # CLI/cron/delegated/Kanban workers. Limits are checked only after a
        # complete model-emitted tool batch, so side-effect batches are never
        # cut halfway. Set enabled:false to opt out.
